...
コールした場合は、お互いのカードを公開してより強いカードを持っている側がポットを獲得します。  
カードの強さは A が最も強く、続いて K、Q の順番です。  
レイズした場合は、宣言した額が保有ポイントから差し引かれ、ポットに加えられます。続いて先手にフォールド、コール、レイズの選択が発生します。  
これを片方がコールまたはフォールドするまで繰り返します。

これを 1ゲームとして、先手と後手を入れ替えてゲームを繰り返します。
...
Bob が 参加費の 2 ポイントおよびレイズで支払われた 7 ポイントの合計 9 ポイントを獲得しました。  
